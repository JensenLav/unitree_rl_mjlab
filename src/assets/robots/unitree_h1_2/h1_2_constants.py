...
# # Actuator config.
# #
# # Training applies multiplicative domain randomization on nominal stiffness / damping
# # (``actuator_pd_gains``) and dof armature (``dof_armature``) in
# # ``src/tasks/velocity/velocity_env_cfg.py`` because hanging-only sysID does not
# # match loaded walking dynamics. Tune ranges there if needed.
# ##
